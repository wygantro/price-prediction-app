...
def daily_price(date_daily):#logger, date_daily):
    """
...
def hour_price(date_hour, next_url=None): #logger, date_hour, next_url=None):
    """
...
def minute_price(date_minute, next_url=None): #logger, date_minute, next_url=None):
    """
