...
while True:
    ...
    if daily_datetime_id != current_datetime()[0]:
        ...
        logger.log(
            logging.INFO, f"daily price values updated and commit: {daily_datetime_id}")
        ...
        logger.log(
            logging.INFO, f"daily feature values updated and commit: {daily_datetime_id}")
    ...
    # check and update hour ID
        ...
        # intra daily update
        logger.log(
            logging.INFO, f"updating intra daily data: {hour_datetime_id}")
    ...
    # check and update minute ID
        ...
        # intra hour update
        logger.log(
            logging.INFO, f"updating intra hour data: {minute_datetime_id}")
